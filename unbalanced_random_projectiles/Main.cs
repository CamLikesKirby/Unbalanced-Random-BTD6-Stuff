...
using unbalanced_random_projectiles;

[assembly: MelonInfo(typeof(unbalanced_random_projectiles.Main), unbalanced_random_projectiles.ModHelperData.Name, unbalanced_random_projectiles.ModHelperData.Version, unbalanced_random_projectiles.ModHelperData.RepoOwner)]
[assembly: MelonGame("Ninja Kiwi", "BloonsTD6")]
namespace unbalanced_random_projectiles
{
    public class Main : BloonsTD6Mod
    {
        ...
        public override void OnApplicationStart()
        {
            ...
            Console.WriteLine("unbalanced_random_projectiles loaded.");
        }
        ...
        public override void OnTowerUpgraded(Tower tower, string upgradeName, TowerModel newBaseTowerModel)
        {
            ...
            try
            {
                ...
                var random = randomTower(newBaseTowerModel.cost, newBaseTowerModel.name).Cast<TowerModel>().Duplicate();
